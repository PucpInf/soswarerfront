    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          name: 'MiPerfil',
          path: 'miperfil',
          component: lazyLoading('MiPerfil/MiPerfil'),
          default: true,
        },
        {
          name: 'Cursos',
          path: 'cursos',
          component: lazyLoading('Cursos/Cursos'),
          default: true,
        },
        {
          name: 'Profesores',
          path: 'profesores',
          component: lazyLoading('Profesores/Profesores'),
          default: true,
        },
        {
          name: 'Investigaciones',
          path: 'investigaciones',
          component: lazyLoading('Investigaciones/Investigaciones'),
          default: true,
        },
        {
          name: 'HistoricoDictado',
          path: 'historicoDictado',
          component: lazyLoading('HistoricoDictado/HistoricoDictado'),
          default: true,
        },
        {
          name: 'AsignacionCarga',
          path: 'asignacionCarga',
          component: lazyLoading('AsignacionCarga/AsignacionCarga'),
          default: true,
        },
        {
          name: 'ConsultaPreferencias',
          path: 'consultaPreferencias',
          component: lazyLoading('ConsultaPreferencias/ConsultaPreferencias'),
          default: true,
        },
        {
          name: 'ResultadoxDocente',
          path: 'resultadoPorDocente',
          component: lazyLoading('ResultadoxDocente/ResultadoxDocente'),
          default: true,
        },
        {
          name: 'AprobacionSeccion',
          path: 'aprobacionSeccion',
          component: lazyLoading('AprobacionSeccion/AprobacionSeccion'),
          default: true,
        },
        {
          name: 'AprobacionDpto',
          path: 'aprobacionDpto',
          component: lazyLoading('AprobacionDpto/AprobacionDpto'),
          default: true,
        },
        {
          name: 'Solicitudes',
          path: 'solicitudes',
          component: lazyLoading('Solicitudes/Solicitudes'),
          default: true,
        },
        {
          name: 'PreferenciasDictado',
          path: 'prefereciasDictado',
          component: lazyLoading('PreferenciasDictado/PreferenciasDictado'),
          default: true,
        },
        {
          name: 'AprobacionDescarga',
          path: 'aprobacionDescarga',
          component: lazyLoading('AprobacionDescarga/AprobacionDescarga'),
          default: true,
        },
        {
          name: 'Mantenimiento',
          ...
          children: [
            {
              name: 'CargaMasiva',
              path: 'cargaMasiva',
              component: lazyLoading('Mantenimiento/CargaMasiva/CargaMasiva'),
            },
            {
              name: 'MantDptoSecc',
              path: 'departamentoSeccion',
              component: lazyLoading('Mantenimiento/MantDptoSecc/MantDptoSecc'),
              meta: {
            ...
            },
            {
              name: 'MantUsuario',
              path: 'usuarios',
              component: lazyLoading('Mantenimiento/MantUsuario/MantUsuario'),
              meta: {
            ...
            },
            {
              ...
              path: 'investigaciones',
              component: lazyLoading('Mantenimiento/MantInvestigacion/MantInvestigacion'),
            },
          ],
        },
        {
